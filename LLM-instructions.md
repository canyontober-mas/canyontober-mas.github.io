...
6.  **Add missing assets from OEM Library** Format calibration setup tab with standardized table that prominently display the target, setup requirements, and example photos.
7.  **LLM insight** Recommended next steps that user did not define.
